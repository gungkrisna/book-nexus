...
import { Pressable, Text, ImageBackground, StyleSheet, View, TextInput, Platform } from 'react-native';
            ...
            {!isSignUpScreen && (
              <>
                ...
                <View style={{ marginBottom: 8 }}>
                  ...
                  >
                    <View style={{ position: 'absolute', left: 16, top: Platform.OS === 'web' ? '25%' : '50%' }}>
                      <GoogleIcon />
                    </View>
